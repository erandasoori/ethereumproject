...
contract InsuranceSystem {
    uint policy_buy_price = 0.001 ether;
    uint policy_claim_price = 0.002 ether;
    string purchased = "Purchased";
    string claimed = "Claimed";

    string[] public policy_statement = [
        "Policy: Flights canceled due to inclement weather will receive 0.002 etherum. Single policy per address."
    ];
